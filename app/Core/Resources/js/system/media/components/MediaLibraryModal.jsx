                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
                    <div className="px-6 py-2 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
                        <TabsList className="bg-transparent p-0 gap-6">
                            <TabsTrigger value="library">{__('library')}</TabsTrigger>
                            <TabsTrigger value="upload">{__('upload')}</TabsTrigger>
                            <TabsTrigger value="url">{__('from_url')}</TabsTrigger>
                            <TabsTrigger value="unsplash">Unsplash</TabsTrigger>
                            <TabsTrigger value="ai">{__('generative_ai')}</TabsTrigger>
                        </TabsList>
                    </div>
                    ...
                    <TabsContent value="library" className="flex-1 flex flex-col p-0 m-0">
                        ...
                        <div className="p-4 border-b flex items-center gap-4 bg-zinc-50/50">
                            ...
                            <Select value={fileType} onValueChange={(val) => { setFileType(val); setPage(1); }}>
                                ...
                                <SelectContent>
                                    <SelectItem value="all">{__('show_all')}</SelectItem>
                        ...
                        <div className="w-full max-w-md space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button onClick={handleUrlUpload} disabled={loading || !externalUrl} className="cursor-pointer">
